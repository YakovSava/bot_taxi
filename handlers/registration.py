...
Разошли пригласительное сообщение своим друзьям &#128071;&#128071;&#128071;')
	...
	await message.answer(f'Смотри каким ботом такси я пользуюсь (https://vk.me/id{id_[0].id})\n\
Создай свою анкету используя мой промокод "{promo[0]}" и получи бесплатные поездку по городу!')
...
Разошли пригласительное сообщение своим друзьям &#128071;&#128071;&#128071;')
	...
	promo = await dispatcher.add_new_promo(message.from_id)
	id_ = await vk.api.groups.get_by_id()
	await message.answwer(f'Смотри каким ботом такси я пользуюсь (https://vk.me/id{id_[0].id})\n\
Создай свою анкету используя мой промокод "{promo[0]}" и получи бесплатные поездку по городу!')
