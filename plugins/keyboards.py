...
class keyboards:
	...
	user_profile = (Keyboard(one_time = False)
		...
		.row()
		.add(Text('Техпод'), color=KeyboardButtonColor.PRIMARY)
	...
	driver_profile = (Keyboard(one_time = False)
		...
		.row()
		.add(Text('Техпод'), color=KeyboardButtonColor.PRIMARY)
		.add(Text('Отключить аккаунт', payload={'driver': 0, 'off': 0}), color=KeyboardButtonColor.NEGATIVE)
	).get_json()
	...
	month_no_activity_driver = (Keyboard(one_time = False)
